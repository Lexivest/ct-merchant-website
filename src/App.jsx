...
const StaffTraffic = createPreloadableStaffRoute("/staff-traffic")
const StaffShopAnalytics = createPreloadableStaffRoute("/staff-shop-analytics")
const StaffUsers = createPreloadableStaffRoute("/staff-users")
...
const StaffIDGenerator = createPreloadableStaffRoute("/staff-issue-id")
const StaffStudio = createPreloadableStaffRoute("/staff-studio")
const StaffInbox = createPreloadableStaffRoute("/staff-inbox")
  ...
  return (
    <Suspense fallback={<RouteSuspenseFallback />}>
      ...
      <Routes>
        ...
        <Route path="/staff-studio" element={<ProtectedStaffRoute adminOnly><StaffStudio /></ProtectedStaffRoute>} />
