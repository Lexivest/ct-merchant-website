-- Add service providers to the authenticated dashboard payload without changing
-- the existing normal shop/product keys. This lets the market and area screens
-- render services alongside shops while keeping shop-only screens stable.
