-- RPC: get_staff_dashboard_payload
-- Consolidates all necessary staff dashboard data and counts into a single request
    ...
    SELECT jsonb_build_object(
        ...
        'counts', jsonb_build_object(
            ...
            'inbox', (
                ...
                (SELECT count(*)::int FROM abuse_reports r 
