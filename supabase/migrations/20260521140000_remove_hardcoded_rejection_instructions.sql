-- Remove the hardcoded trailing instructions appended to rejection
-- notifications for shop applications and video KYC.
--
-- Before: message ended with either
...
--
-- These were too prescriptive — a submission can be rejected for reasons
-- unrelated to document quality or video clarity.  The staff-entered
-- rejection reason already explains what needs to be fixed; no generic
...
BEGIN
  ...
  -- Shop / service application status changes
