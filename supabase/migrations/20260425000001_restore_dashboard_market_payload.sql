-- Restore the market dashboard payload to a single authoritative RPC.
-- This keeps the market section fully RPC-driven and ensures shop cards
-- receive both active shops and their approved products in one payload.
