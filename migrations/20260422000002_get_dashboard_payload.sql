...
-- RPC: GET DASHBOARD PAYLOAD
-- Gathers all necessary dashboard data in a single round-trip to the server

CREATE OR REPLACE FUNCTION public.get_dashboard_payload(p_user_id uuid, p_city_id bigint)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
BEGIN
    SELECT jsonb_build_object(
        ...
        'staff_discoveries', (
            ...
            FROM (
                SELECT * FROM public.staff_discoveries
