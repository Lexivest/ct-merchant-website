-- Fresh analytics migration to ensure the merchant recent-contact feed is
-- deduplicated to one latest row per actor, and the staff radar function keeps
-- the fixed, unambiguous actor_user_id handling when pushed to remote.
