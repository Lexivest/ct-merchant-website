-- Replace merchant Instagram/TikTok collection with Telegram while keeping
-- the old columns nullable for legacy rows and older app builds.

ALTER TABLE public.shops
  ADD COLUMN IF NOT EXISTS telegram_url text;

COMMENT ON COLUMN public.shops.telegram_url IS 'Optional public Telegram channel or profile URL for the merchant shop.';
