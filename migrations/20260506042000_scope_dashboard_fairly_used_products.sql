-- Keep the market dashboard "Fairly Used Items" rail scoped to the active city.
-- The previous payload filtered normal shops/products by p_city_id but missed the
-- same predicate for fairly-used products, allowing active shops from other cities
-- to appear in the current city dashboard.
